...
fun NavGraphBuilder.postLoginNavGraph() {
    navigation(startDestination = PostLoginDirection.Home.destination, route = PostLoginDirection.Root.destination) {
        ...
        composable(route = PostLoginDirection.ParkingSpaces.destination, arguments = PostLoginDirection.ParkingSpaces.arguments) {
            ParkingSpacesScreen()
        }
        ...
        composable(route = PostLoginDirection.CreateOffer.destination, arguments = PostLoginDirection.CreateOffer.arguments) {
            CreateOfferScreen()
        }
    }
}
