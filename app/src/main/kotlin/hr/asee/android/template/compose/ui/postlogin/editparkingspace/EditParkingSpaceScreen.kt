...
import hr.asee.android.template.compose.ui.postlogin.usermanagement.UserManagementViewModel
...
fun EditParkingSpaceScreen(viewModel: EditParkingSpaceViewModel = hiltViewModel(), parkingSpaceId: Int = 0) {
    ...
    val parkingSpace = viewModel.getParkingSpace(accountState, parkingSpaceId)
