    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Image(
                    painter = painterResource(R.drawable.parking_request),
                ...
                Column {
                    LabelText(
                        text = stringResource(R.string.parking_manager_screen_seeker_request_parking_retrival_request_label),
                        fontSize = 15.sp,
                        color = LightGray
                    )
