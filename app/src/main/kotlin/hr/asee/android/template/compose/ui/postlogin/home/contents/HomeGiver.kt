...
fun HomeScreenGiverContent(
    ...
    val noContent by remember{ mutableStateOf(User.seekings.size + giver.reservations.size + giver.offers.size == 0) }
    ...
    Column(
        ...
        if (noContent) {
            ...
            Text(
                text = stringResource(id = R.string.home_screen_giver_no_content_label),
            ...
            Row(horizontalArrangement = Arrangement.SpaceBetween) {
                Text(
                    text = stringResource(id = R.string.home_screen_giver_offer_list_label),
                    fontFamily = Geomanist,
                    fontSize = 20.sp,
                    fontWeight = FontWeight.Bold
                )
            ...
            Text(
                text = stringResource(id = R.string.home_screen_giver_reservation_list_label),
                fontFamily = Geomanist,
                fontSize = 20.sp,
                fontWeight = FontWeight.Bold,
            ...
            ReservationList(
                reservationList = giver.reservations,
                user = giver,
                filterState = filterState,
                viewModel = viewModel
            )
            ...
            Text(
                text = stringResource(id = R.string.home_screen_giver_seeking_list_label),
                fontFamily = Geomanist,
                fontSize = 20.sp,
                fontWeight = FontWeight.Bold,
                modifier = Modifier.align(Alignment.Start)
