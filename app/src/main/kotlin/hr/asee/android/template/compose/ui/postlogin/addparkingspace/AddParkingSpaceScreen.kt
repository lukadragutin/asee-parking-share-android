...
@Composable
fun AddParkingSpaceScreen(viewModel: AddParkingSpaceViewModel = hiltViewModel()) {
    ...
    AndroidComposeCodingTemplateTheme(
        ...
        Column(modifier = Modifier.background(MaterialTheme.colors.surface)) {
            ...
            DefaultScreenLayout(
                screenTitle = stringResource(id = R.string.add_parking_space_screen_title_label),
                ...
                ParkingSpaceScreenContent(
                    accountState = accountState,
                    parkingNumberState = parkingNumberState,
                    onAddParkingSpaceClicked = viewModel::onAddParkingSpaceClicked
                )
            }
        }
    }
...
@Composable
fun ParkingSpaceScreenContent(
    accountState: AccountState,
    parkingNumberState: InputFieldState,
    onAddParkingSpaceClicked: (ParkingSpace) -> Unit
) {
    val parkingSpace = ParkingSpace(location = parkingNumberState.text, owner = accountState.user as Giver?)
    ...
    Column(
        ...
        InputField(
            ...
            label = stringResource(id = R.string.add_parking_space_screen_parking_number_field_label),
        ...
        BlueButton(
            label = stringResource(id = R.string.add_parking_space_screen_button_label),
            onClick = { onAddParkingSpaceClicked(parkingSpace) }
        )
