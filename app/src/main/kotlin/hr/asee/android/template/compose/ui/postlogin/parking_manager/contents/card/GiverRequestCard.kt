    ...
    shape = RoundedCornerShape(15)
        ...
        Column(
            ...
            Row(
                ...
                Image(
                    painter = painterResource(R.drawable.parking_giver_request),
                    contentDescription = stringResource(id = R.string.parking_manager_screen_giver_request_card_image_content_description),
                ...
                Column{
                    LabelText(
                        text = stringResource(R.string.parking_manager_screen_giver_request_parking_reservation_request_label),
                        fontSize = 15.sp,
                        color = LightGray
                    )
                    ...
                    LabelText(
                        text = stringResource(R.string.parking_manager_screen_seeker_request_reservation_id_label) + " " + request.id,
                        fontSize = 20.sp
                    )
                }
                ...
                Icon(
                    modifier = Modifier
                        ...
                        .clickable(
                            ...
                            onClick = onForwardClickedRequestsCard
                        ),
